			...
			<div class="row">
				<div class="col-xs-6 col-sm-6 col-md-6">
					<address>
						...
						:${order.product.prodsell.sellername}
											</address>
				</div>
					...
					<tbody>
						<tr>
							<td class="col-md-10"><em></em>
								<div>
									<img src="${cr}/resources/productimages/${order.product.prodid}.jpg"
										alt="allytees-500-trans.png" width="50" height="50"> <span>${order.product.prodname}</span>
								</div></td>
